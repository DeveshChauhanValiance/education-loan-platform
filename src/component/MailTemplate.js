      ...
      <div>
        ...
        <div>
          ...
          <FormGroup className={"template__inputs"}>
            <Input type="text" name="link" placeholder="Enter Link" onBlur={(event) => { this.props.setToLocal("link", event) }} />
          </FormGroup>
        </div>
        <br/>
        <div>
...
export default class MailTemplate extends React.Component {
  ...
  render () {
        if(this.props.templateNo === 0) {
            ...
            return <MailTemplate1 BankName={this.state.BankName} setToLocal={this.props.setToLocal}/>
        } else if(this.props.templateNo === 2) {
            return <MailTemplate2 BankName={this.state.BankName} setToLocal={this.props.setToLocal}/>
        } else if(this.props.templateNo === 3) {
            return <MailTemplate3 BankName={this.state.BankName} setToLocal={this.props.setToLocal}/>
        }
    }
}